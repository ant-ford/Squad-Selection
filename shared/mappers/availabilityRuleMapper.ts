import { AvailabilityRule, AvailabilityRuleType } from '../schema/domainTypes';
import { AVAILABILITYRULES_FIELDS } from '../schema/fieldMaps';
...
export function mapAvailabilityRule(record: any): AvailabilityRule {
  ...
  return {
    ...
    ruleType: (linkId(f[AVAILABILITYRULES_FIELDS.ruleType]) || '') as AvailabilityRuleType | '',
    availability: (linkId(f[AVAILABILITYRULES_FIELDS.availability]) || '') as AvailabilityRule['availability'],
