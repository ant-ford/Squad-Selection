      ...
      <div className="container mx-auto px-3 sm:px-4 py-2 sm:py-3 flex items-center justify-between gap-2">
        <div className="flex items-baseline gap-2 min-w-0">
          ...
          {/* Shortens rather than sliding under the actions when a header has many
              (an officer who also coaches); the logo always stays. */}
          <p className="text-base sm:text-lg font-semibold text-foreground truncate">HKFC Squad</p>
...
export const headerIconClass =
  'p-1.5 sm:p-2 text-muted-foreground hover:text-foreground transition-colors';
