...
import { CHAIRMAN_DIRECTORY_KEY, MEMBERSHIP_RECORDS_KEY, OFFICER_LINKS_KEY } from "./reference";
...
const INVALIDATION: Record<string, { keys?: string[]; sharedPrefixes?: SharedPrefix[]; localPrefixes?: string[] }> = {
  [TABLES.player]: {
    keys: ["club-reference", "ranking:active", "ranking:inactive", MEMBERSHIP_RECORDS_KEY, CHAIRMAN_DIRECTORY_KEY],
